...
//                   .afterTime(.1, outtakeClaw.open())
                    .splineToConstantHeading(new Vector2d(pickupXPosition, 55), Math.toRadians(89.9), new TranslationalVelConstraint(35), new ProfileAccelConstraint(-40.0, 68.0)) //change from 46 to 55
                    //     .waitSeconds(.001) //change from 0.5 to 0.1
                    .setTangent(Math.toRadians(90))
                    .strafeTo(new Vector2d(pickupXPosition, 62.5), new TranslationalVelConstraint(15), new ProfileAccelConstraint(-20.0, 68.0)) //change from 46 to 55
...
//                    .afterTime(.1, outtakeClaw.open())
                    .splineToLinearHeading(new Pose2d(pickupXPosition, 55,Math.toRadians(-90.0)),Math.toRadians(90), null, new ProfileAccelConstraint(-45.0, 68.0))
                    .setTangent(Math.toRadians(90))
                    .strafeTo(new Vector2d(pickupXPosition,62.5),  new TranslationalVelConstraint(15), new ProfileAccelConstraint(-30.0, 68.0)) //TODO Maybe reduce max decel
//                    .stopAndAdd(outtakeClaw.close())
//                    .stopAndAdd(outtakeSlide.extendAction())
...
//                    .afterTime(.1, outtakeClaw.open())
                    .splineToLinearHeading(new Pose2d(pickupXPosition, 55,Math.toRadians(-90.0)),Math.toRadians(90), null, new ProfileAccelConstraint(-45.0, 68.0))
                    .setTangent(Math.toRadians(90))
                    .strafeTo(new Vector2d(pickupXPosition,62.5), new TranslationalVelConstraint(15), new ProfileAccelConstraint(-20.0, 68.0)) //TODO Maybe reduce max decel
//                    .stopAndAdd(outtakeClaw.close())
//                    .stopAndAdd(outtakeSlide.extendAction())
                    .setTangent(Math.toRadians(-40))
//                    .afterTime(.01, outtakeSlide.specimenDrop())
...
//                    .stopAndAdd(outtakeSlide.specimenDropDown()) //TODO move before slide goes to low
                    ...
                    .setTangent(Math.toRadians(150))
//                    .afterTime(.1, outtakeClaw.open())
                    .splineToLinearHeading(new Pose2d(pickupXPosition, 55,Math.toRadians(-90)),Math.toRadians(90), null, new ProfileAccelConstraint(-45.0, 68.0))
                    .setTangent(Math.toRadians(90))
                    .strafeTo(new Vector2d(pickupXPosition,62.5), new TranslationalVelConstraint(15), new ProfileAccelConstraint(-20.0, 68.0)) //TODO Maybe reduce max decel
//                   .stopAndAdd(outtakeClaw.close())
//                    .stopAndAdd(outtakeSlide.extendAction())
