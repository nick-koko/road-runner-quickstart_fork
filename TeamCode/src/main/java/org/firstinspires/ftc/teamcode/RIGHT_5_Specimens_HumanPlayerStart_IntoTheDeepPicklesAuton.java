...
*/
           ...
           //     .strafeTo(new Vector2d(-46.5,62.5)) //TODO Maybe reduce max decel
                ...
                .splineToLinearHeading(new Pose2d(-6.0, 31.5,Math.toRadians(89.9)),Math.toRadians(-50), null, new ProfileAccelConstraint(-38.0, 68.0)) //TODO Fix drop location and slow down decel
                .stopAndAdd(outtakeSlide.specimenDropDown()) //TODO move before slide goes to low
                .setTangent(Math.toRadians(150))
                .afterTime(.1, outtakeClaw.open())
                ...
                .splineToLinearHeading(new Pose2d(-8.0, 31.5,Math.toRadians(89.9)),Math.toRadians(-63), null, new ProfileAccelConstraint(-38.0, 68.0)) //TODO Fix drop location and slow down decel
                .stopAndAdd(outtakeSlide.specimenDropDown()) //TODO move before slide goes to low
