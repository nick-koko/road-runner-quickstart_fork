...
@Config
@Autonomous(name = "LEFT_START_With_SPECIMEN_CLIP_GigglyPicklesAuton", group = "Autonomous")
public class LEFT_START_WithSpecimenClip_IntoTheDeepPicklesAuton extends LinearOpMode {
...
*/
       ...
       trajectoryActionLeftSideBuckets = drive.actionBuilder(initialPoseLeftSideBuckets)
        ...
        while (opModeInInit()) {
            fieldSide = SIDE.LEFT;
            startingPose =  initialPoseLeftSideBuckets;
            drive.pose = startingPose;
            numPieces = 3;
        ...
        Actions.runBlocking(
                new SequentialAction(
                        trajectoryActionLeftSideBuckets
                )
        );
